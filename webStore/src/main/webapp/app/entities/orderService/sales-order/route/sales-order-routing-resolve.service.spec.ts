...
describe('SalesOrder routing resolve service', () => {
  ...
  let routingResolveService: SalesOrderRoutingResolveService;
  let service: SalesOrderService;
  let resultSalesOrder: ISalesOrder | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(SalesOrderRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new ISalesOrder if id is not provided', () => {
      // GIVEN
      ...
      expect(resultSalesOrder).toEqual(new SalesOrder());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as SalesOrder })));
      mockActivatedRouteSnapshot.params = { id: 123 };
