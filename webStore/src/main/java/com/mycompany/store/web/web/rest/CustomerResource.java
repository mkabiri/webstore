...
public class CustomerResource {
    ...
    public Mono<List<CustomerDTO>> getAllCustomers(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public Mono<List<CustomerDTO>> searchCustomers(@RequestParam String query) {
        log.debug("REST request to search Customers for query {}", query);
        return customerService.search(query).collectList();
    }
}
